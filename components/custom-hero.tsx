      ...
      <div className="absolute bottom-8 left-0 right-0 z-[999999] pointer-events-none">
        <div className="mx-auto flex max-w-7xl items-end justify-between p-4 md:p-8">
          <div className="pointer-events-auto">
            <h1 className="mb-6 max-w-4xl text-5xl font-black leading-[1.1] text-white md:text-7xl">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="mt-8 bg-blue-500 text-white px-8 py-3 rounded-full font-bold hover:bg-blue-600 transition-colors"
            >
              Get Started
            </motion.button>
          </div>
          <FiArrowDownCircle className="hidden text-8xl text-white/70 md:block pointer-events-auto cursor-pointer hover:text-white transition-colors" />
        </div>
      </div>
    </div>
  )
