        ...
        <div className="flex flex-col flex-1 min-w-0">
          ...
          <header className="sticky top-0 z-20 w-full border-b border-gray-200/80 bg-white/90 backdrop-blur-xl shadow-sm">
            <div className="flex h-16 items-center gap-4 px-4">
              ...
              <Link
                href="/"
                className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-700 hover:text-blue-600 hover:bg-blue-50/80 rounded-lg transition-all duration-200 ring-1 ring-gray-200/50 hover:ring-blue-300/50"
              >
