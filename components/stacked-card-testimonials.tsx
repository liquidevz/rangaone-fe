...
const Cards = ({ testimonials, selected, setSelected }: { testimonials: any[]; selected: number; setSelected: Dispatch<SetStateAction<number>> }) => {
  return (
...
const Card = ({
  ...
  selected,
  setSelected,
}: { Icon: IconType; description: string; name: string; title: string; position: number; selected: number; setSelected: Dispatch<SetStateAction<number>> }) => {
